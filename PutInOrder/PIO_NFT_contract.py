...
Based on NEO Non-Fungible Token Smart Contract Template

Team: Put in Order
Status: Untested as we could not successfully run neo-local through docker on any of our machines
"""
